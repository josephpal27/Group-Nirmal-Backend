...
<head>
  ...
  border-bottom: 1px solid rgba(0, 0, 0, 0.1); /* Adjusted for light background */
}
...
<div class="col-md-3">
  ...
  <!-- Categories Card -->
  <div class="col-md-3">
    <a href="dashboard.php?page=blog-categories" class="text-decoration-none">
      <div class="custom-card">
        <i class="bi bi-tags-fill"></i>
        <div class="custom-card-title">Categories</div>
      </div>
    </a>
  </div>
