...
<body>
    ...
    <section class="banner">
        <img src="assets/images/blog/collective-blog-banner.png" alt="banner" loading="lazy">
          ...
          <div class="blog-card-row">
            <?php foreach ($slideBlogs as $blog): ?>
              <div class="blog-card" data-aos="fade" data-aos-duration="1000">
                <div class="card-img">
                  <img src="uploads/blogs/<?php echo htmlspecialchars($blog['image']); ?>" alt="<?php echo htmlspecialchars($blog['title']); ?>" loading="lazy">
                </div>
                <div class="card-body">
